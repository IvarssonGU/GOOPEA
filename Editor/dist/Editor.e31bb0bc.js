...
*/
var MapMode = exports.MapMode = /*@__PURE__*/function (MapMode) {
  /**
...
class EditorSelection {
  ...
  */
  static cursor(pos, assoc = 0, bidiLevel, goalColumn) {
    return SelectionRange.create(pos, pos, (assoc == 0 ? 0 : assoc < 0 ? 4 /* AssocBefore */ : 8 /* AssocAfter */) | (bidiLevel == null ? 3 : Math.min(2, bidiLevel)) | (goalColumn !== null && goalColumn !== void 0 ? goalColumn : 33554431 /* NoGoalColumn */) << 5 /* GoalColumnOffset */);
  }
  /**
  ...
  */
  static range(anchor, head, goalColumn) {
    ...
    return head < anchor ? SelectionRange.create(head, anchor, 16 /* Inverted */ | goal | 8 /* AssocAfter */) : SelectionRange.create(anchor, head, goal | (head > anchor ? 4 /* AssocBefore */ : 0));
  }
  /**
  @internal
  */
...
function ensureAll(state, addrs) {
  let changed = false;
  for (let addr of addrs) if (ensureAddr(state, addr) & 1 /* Changed */) changed = true;
  return changed;
}
function dynamicFacetSlot(addresses, facet, providers) {
  ...
  function get(state) {
    ...
    for (let i = 0; i < providerAddrs.length; i++) {
      ...
      if (providerTypes[i] == 2 /* Multi */) for (let val of value) values.push(val);else values.push(value);
    }
...
*/
var CharCategory = exports.CharCategory = /*@__PURE__*/function (CharCategory) {
  /**
  Word characters.
  */
...
},{"process":"node_modules/process/browser.js"}],"node_modules/style-mod/src/style-mod.js":[function(require,module,exports) {
"use strict";
...
// (min-width: 400px)": {...}}`.
},{}],"node_modules/w3c-keyname/index.js":[function(require,module,exports) {
"use strict";
...
var BlockType = exports.BlockType = /*@__PURE__*/function (BlockType) {
  /**
  A line of text.
  */
...
class ContentBuilder {
  ...
  finish(openEnd) {
    if (!openEnd) this.flushBuffer([]);else this.pendingBuffer = 0 /* No */;
  ...
  ensureLineGaps(current) {
    ...
    for (let line of this.viewportLines) {
      ...
      for (let {
        from,
        to
      } of outside) if (to - from > 1000 /* HalfMargin */) {
        gaps.push(find(current, gap => gap.from >= line.from && gap.to <= line.to && Math.abs(gap.from - from) < 1000 /* HalfMargin */ && Math.abs(gap.to - to) < 1000 /* HalfMargin */) || new LineGap(from, to, this.gapSize(line, from, to, structure)));
      }
    }
    return gaps;
  }
...
class DOMObserver {
  ...
  delayAndroidKey(key, keyCode) {
    if (!this.delayedAndroidKey) requestAnimationFrame(() => {
      ...
      this.delayedAndroidKey = null;
      this.delayedFlush = -1;
      if (!this.flush()) dispatchKey(this.view.contentDOM, key.key, key.keyCode);
    });
...
*/
const keymap = exports.keymap = /*@__PURE__*/_state.Facet.define({
...
*/
const showTooltip = exports.showTooltip = /*@__PURE__*/_state.Facet.define({
...
*/
const closeHoverTooltips = exports.closeHoverTooltips = /*@__PURE__*/closeHoverTooltipEffect.of(null);
/**
...
*/
const showPanel = exports.showPanel = /*@__PURE__*/_state.Facet.define({
  enables: panelPlugin
});
...
*/
const gutterLineClass = exports.gutterLineClass = /*@__PURE__*/_state.Facet.define();
const defaults = {
  class: "",
...
*/
const lineNumberMarkers = exports.lineNumberMarkers = /*@__PURE__*/_state.Facet.define();
...
},{"@codemirror/state":"node_modules/@codemirror/state/dist/index.js","style-mod":"node_modules/style-mod/src/style-mod.js","w3c-keyname":"node_modules/w3c-keyname/index.js"}],"node_modules/@lezer/common/dist/index.js":[function(require,module,exports) {
"use strict";
...
const DefaultBufferLength = exports.DefaultBufferLength = 1024;
let nextPropID = 0;
class Range {
  constructor(from, to) {
    this.from = from;
...
},{}],"node_modules/@lezer/highlight/dist/index.js":[function(require,module,exports) {
"use strict";
...
const classHighlighter = exports.classHighlighter = tagHighlighter([{
  tag: tags.link,
  class: "tok-link"
}, {
  tag: tags.heading,
...
},{"@lezer/common":"node_modules/@lezer/common/dist/index.js"}],"node_modules/@codemirror/language/dist/index.js":[function(require,module,exports) {
"use strict";
...
exports.foldService = exports.foldNodeProp = exports.foldKeymap = void 0;
...
*/
const languageDataProp = exports.languageDataProp = /*@__PURE__*/new _common.NodeProp();
/**
...
*/
const language = exports.language = /*@__PURE__*/_state2.Facet.define({
  combine(languages) {
...
const indentService = exports.indentService = /*@__PURE__*/_state2.Facet.define();
/**
Facet for overriding the unit by which indentation happens.
Should be a string consisting either entirely of spaces or
entirely of tabs. When not set, this defaults to 2 spaces.
*/
const indentUnit = exports.indentUnit = /*@__PURE__*/_state2.Facet.define({
  combine: values => {
...
const indentNodeProp = exports.indentNodeProp = /*@__PURE__*/new _common.NodeProp();
...
can be found.
*/
const foldService = exports.foldService = /*@__PURE__*/_state2.Facet.define();
/**
...
when it is.
*/
const foldNodeProp = exports.foldNodeProp = /*@__PURE__*/new _common.NodeProp();
/**
...
*/
const foldEffect = exports.foldEffect = /*@__PURE__*/_state2.StateEffect.define({
  map: mapRange
});
/**
State effect that unfolds the given range (if it was folded).
*/
const unfoldEffect = exports.unfoldEffect = /*@__PURE__*/_state2.StateEffect.define({
  map: mapRange
});
...
const foldKeymap = exports.foldKeymap = [{
  key: "Ctrl-Shift-[",
  mac: "Cmd-Alt-[",
  run: foldCode
}, {
...
*/
const defaultHighlightStyle = exports.defaultHighlightStyle = /*@__PURE__*/HighlightStyle.define([{
...
*/
const toggleLineComment = exports.toggleLineComment = /*@__PURE__*/command(changeLineComment, 0 /* Toggle */);
/**
Comment the current selection using line comments.
*/
const lineComment = exports.lineComment = /*@__PURE__*/command(changeLineComment, 1 /* Comment */);
/**
Uncomment the current selection using line comments.
*/
const lineUncomment = exports.lineUncomment = /*@__PURE__*/command(changeLineComment, 2 /* Uncomment */);
/**
...
data](https://codemirror.net/6/docs/ref/#state.EditorState.languageDataAt).
*/
const toggleBlockComment = exports.toggleBlockComment = /*@__PURE__*/command(changeBlockComment, 0 /* Toggle */);
/**
Comment the current selection using block comments.
*/
const blockComment = exports.blockComment = /*@__PURE__*/command(changeBlockComment, 1 /* Comment */);
/**
Uncomment the current selection using block comments.
*/
const blockUncomment = exports.blockUncomment = /*@__PURE__*/command(changeBlockComment, 2 /* Uncomment */);
/**
Comment or uncomment the lines around the current selection using
block comments.
*/
const toggleBlockCommentByLine = exports.toggleBlockCommentByLine = /*@__PURE__*/command((o, s) => changeBlockComment(o, s, selectedLineRanges(s)), 0 /* Toggle */);
...
*/
const isolateHistory = exports.isolateHistory = /*@__PURE__*/_state.Annotation.define();
/**
...
*/
const invertedEffects = exports.invertedEffects = /*@__PURE__*/_state.Facet.define();
...
*/
const historyField = exports.historyField = historyField_;
...
was available.
*/
const undo = exports.undo = /*@__PURE__*/cmd(0 /* Done */, false);
/**
Redo a group of history events. Returns false if no group was
available.
*/
const redo = exports.redo = /*@__PURE__*/cmd(1 /* Undone */, false);
/**
Undo a change or selection change.
*/
const undoSelection = exports.undoSelection = /*@__PURE__*/cmd(0 /* Done */, true);
/**
Redo a change or selection change.
*/
const redoSelection = exports.redoSelection = /*@__PURE__*/cmd(1 /* Undone */, true);
function depth(side) {
...
*/
const undoDepth = exports.undoDepth = /*@__PURE__*/depth(0 /* Done */);
/**
The amount of redoable change events available in a given state.
*/
const redoDepth = exports.redoDepth = /*@__PURE__*/depth(1 /* Undone */);
...
class HistoryState {
  ...
  addChanges(event, time, userEvent, newGroupDelay, maxLen) {
    ...
    if (lastEvent && lastEvent.changes && !lastEvent.changes.empty && event.changes && (!userEvent || joinableUserEvent.test(userEvent)) && (!lastEvent.selectionsAfter.length && time - this.prevTime < newGroupDelay && isAdjacent(lastEvent.changes, event.changes) ||
...
*/
const historyKeymap = exports.historyKeymap = [{
  key: "Mod-z",
  run: undo,
  preventDefault: true
}, {
...
the cursor.
*/
const insertNewlineAndIndent = exports.insertNewlineAndIndent = /*@__PURE__*/newlineAndIndent(false);
/**
Create a blank, indented line below the current line.
*/
const insertBlankLine = exports.insertBlankLine = /*@__PURE__*/newlineAndIndent(true);
...
const emacsStyleKeymap = exports.emacsStyleKeymap = [{
  key: "Ctrl-b",
  run: cursorCharLeft,
...
*/
const standardKeymap = exports.standardKeymap = /*@__PURE__*/[{
  key: "ArrowLeft",
  run: cursorCharLeft,
  shift: selectCharLeft,
  preventDefault: true
...
*/
const defaultKeymap = exports.defaultKeymap = /*@__PURE__*/[{
  key: "Alt-ArrowLeft",
  mac: "Ctrl-ArrowLeft",
...
this.
*/
const indentWithTab = exports.indentWithTab = {
  key: "Tab",
  run: indentMore,
  shift: indentLess
};
},{"@codemirror/state":"node_modules/@codemirror/state/dist/index.js","@codemirror/view":"node_modules/@codemirror/view/dist/index.js","@codemirror/language":"node_modules/@codemirror/language/dist/index.js","@lezer/common":"node_modules/@lezer/common/dist/index.js"}],"node_modules/crelt/index.js":[function(require,module,exports) {
"use strict";
...
once).
*/
const setSearchQuery = exports.setSearchQuery = /*@__PURE__*/_state.StateEffect.define();
...
*/
const findNext = exports.findNext = /*@__PURE__*/searchCommand((view, {
  query
}) => {
  let {
    from,
...
*/
const findPrevious = exports.findPrevious = /*@__PURE__*/searchCommand((view, {
  query
}) => {
  let {
      state
...
*/
const selectMatches = exports.selectMatches = /*@__PURE__*/searchCommand((view, {
  query
}) => {
...
const replaceNext = exports.replaceNext = /*@__PURE__*/searchCommand((view, {
  query
}) => {
  let {
      state
...
replacement.
*/
const replaceAll = exports.replaceAll = /*@__PURE__*/searchCommand((view, {
  query
}) => {
  if (view.state.readOnly) return false;
...
const searchKeymap = exports.searchKeymap = [{
  key: "Mod-f",
  run: openSearchPanel,
...
},{"@codemirror/view":"node_modules/@codemirror/view/dist/index.js","@codemirror/state":"node_modules/@codemirror/state/dist/index.js","crelt":"node_modules/crelt/index.js"}],"node_modules/@codemirror/autocomplete/dist/index.js":[function(require,module,exports) {
"use strict";
...
*/
const pickedCompletion = exports.pickedCompletion = /*@__PURE__*/_state.Annotation.define();
/**
...
class FuzzyMatcher {
  ...
  match(word) {
    ...
    if (chars.length == 1) {
      ...
      return first == chars[0] ? [0, 0, (0, _state.codePointSize)(first)] : first == folded[0] ? [-200 /* CaseFold */, 0, (0, _state.codePointSize)(first)] : null;
    }
...
const nextSnippetField = exports.nextSnippetField = /*@__PURE__*/moveField(1);
/**
Move to the previous snippet field, if available.
*/
const prevSnippetField = exports.prevSnippetField = /*@__PURE__*/moveField(-1);
...
*/
const snippetKeymap = exports.snippetKeymap = /*@__PURE__*/_state.Facet.define({
  combine(maps) {
...
const closeBracketsKeymap = exports.closeBracketsKeymap = [{
  key: "Backspace",
...
*/
const completionKeymap = exports.completionKeymap = [{
  key: "Ctrl-Space",
  run: startCompletion
}, {
  key: "Escape",
...
},{"@codemirror/state":"node_modules/@codemirror/state/dist/index.js","@codemirror/view":"node_modules/@codemirror/view/dist/index.js","@codemirror/language":"node_modules/@codemirror/language/dist/index.js"}],"node_modules/@codemirror/lint/dist/index.js":[function(require,module,exports) {
"use strict";
...
*/
const setDiagnosticsEffect = exports.setDiagnosticsEffect = /*@__PURE__*/_state.StateEffect.define();
const togglePanel = /*@__PURE__*/_state.StateEffect.define();
...
const lintKeymap = exports.lintKeymap = [{
  key: "Mod-Shift-m",
  run: openLintPanel
}, {
  key: "F8",
...
},{"@codemirror/view":"node_modules/@codemirror/view/dist/index.js","@codemirror/state":"node_modules/@codemirror/state/dist/index.js","crelt":"node_modules/crelt/index.js"}],"node_modules/@codemirror/basic-setup/dist/index.js":[function(require,module,exports) {
"use strict";
...
desired.
*/
const basicSetup = exports.basicSetup = [/*@__PURE__*/(0, _view.lineNumbers)(), /*@__PURE__*/(0, _view.highlightActiveLineGutter)(), /*@__PURE__*/(0, _view.highlightSpecialChars)(), /*@__PURE__*/(0, _commands.history)(), /*@__PURE__*/(0, _language.foldGutter)(), /*@__PURE__*/(0, _view.drawSelection)(), /*@__PURE__*/(0, _view.dropCursor)(), /*@__PURE__*/_state.EditorState.allowMultipleSelections.of(true), /*@__PURE__*/(0, _language.indentOnInput)(), /*@__PURE__*/(0, _language.syntaxHighlighting)(_language.defaultHighlightStyle, {
  fallback: true
}), /*@__PURE__*/(0, _language.bracketMatching)(), /*@__PURE__*/(0, _autocomplete.closeBrackets)(), /*@__PURE__*/(0, _autocomplete.autocompletion)(), /*@__PURE__*/(0, _view.rectangularSelection)(), /*@__PURE__*/(0, _view.crosshairCursor)(), /*@__PURE__*/(0, _view.highlightActiveLine)(), /*@__PURE__*/(0, _search.highlightSelectionMatches)(), /*@__PURE__*/_view.keymap.of([..._autocomplete.closeBracketsKeymap, ..._commands.defaultKeymap, ..._search.searchKeymap, ..._commands.historyKeymap, ..._language.foldKeymap, ..._autocomplete.completionKeymap, ..._lint.lintKeymap])];
},{"@codemirror/view":"node_modules/@codemirror/view/dist/index.js","@codemirror/state":"node_modules/@codemirror/state/dist/index.js","@codemirror/language":"node_modules/@codemirror/language/dist/index.js","@codemirror/commands":"node_modules/@codemirror/commands/dist/index.js","@codemirror/search":"node_modules/@codemirror/search/dist/index.js","@codemirror/autocomplete":"node_modules/@codemirror/autocomplete/dist/index.js","@codemirror/lint":"node_modules/@codemirror/lint/dist/index.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _basicSetup = require("@codemirror/basic-setup");
var initialState = _basicSetup.EditorState.create({
  doc: '',
  extensions: [_basicSetup.basicSetup]
});
var view = new _basicSetup.EditorView({
  parent: document.getElementById('editor'),
  state: initialState
});
},{"@codemirror/basic-setup":"node_modules/@codemirror/basic-setup/dist/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
